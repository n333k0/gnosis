...
const dynamicAgentSystemPrompt = `You are a focused subagent spawned by Gnosis's chat coordinator.
...
// AgentRunner runs chat-spawned subagents on Gnosis's core agent loop. Each call
