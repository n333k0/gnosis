// Package phase provides Gnosis's built-in and configured named prompts.
...
// Resolve overlays configured definitions on Gnosis's defaults. Defaults retain
...
func ExpandInvocation(definition Definition, args string) string {
	...
	b.WriteString("Apply this named prompt with the normal Gnosis tools and workflow behavior.\n")
