...
Named phases are focused prompts for one interactive turn. Gnosis ships with
...
The `phases` map in `gnosis.yaml` adds a named prompt or overrides a default by
