...
Options:
  --bin-dir <dir>       Directory to install gnosis into  (default: ~/.local/bin)
...
main() {
  ...
  echo ""
  success "Done!  Run ${BOLD}gnosis${RESET}${GREEN} to start."
  echo ""
}
