...
- Redacted Google and OpenRouter API keys everywhere Gnosis sanitizes provider
...
- Kept interactive `@` file references rooted at Gnosis's effective startup
...
- Added visible, configurable named phases with built-in `/design`, `/plan`,
  ...
  be extended or overridden through `gnosis.yaml`. They activate only through
...
- Replaced permission modes and command-risk heuristics with default-empty,
  interactive-only `tool_approvals`. Gnosis now treats its VM or sandbox as the
...
- Headless mode for running Gnosis non-interactively from the CLI.
...
- Replaced `.gnosis/commands` prompt templates and `features.prompt_commands` with slash-invoked `.gnosis/skills`; existing custom prompt commands must be migrated to skills.
- Removed project memory and its bundled repository artifacts to keep Gnosis focused on explicit project instructions, skills, and local sessions.
...
- Ran independent `gnosis doctor` checks even when configuration loading fails.
- Removed redundant tool output, duplicate max-turn summaries, and dead retry wrappers.
- Installed Gnosis onto a runnable path more reliably.

## [v0.2.2] - 2026-07-07

### Changed

- Published a patch release to verify the configured Homebrew tap token updates `n333k0/homebrew-tap` during release automation.
...
- `gnosis doctor` command for environment diagnostics.
...
[v0.6.2]: https://github.com/n333k0/gnosis/compare/v0.6.1...v0.6.2
[v0.6.1]: https://github.com/n333k0/gnosis/compare/v0.6.0...v0.6.1
[v0.6.0]: https://github.com/n333k0/gnosis/compare/v0.5.1...v0.6.0
[v0.5.1]: https://github.com/n333k0/gnosis/compare/v0.5.0...v0.5.1
[v0.5.0]: https://github.com/n333k0/gnosis/compare/v0.4.1...v0.5.0
[v0.4.1]: https://github.com/n333k0/gnosis/compare/v0.4.0...v0.4.1
[v0.4.0]: https://github.com/n333k0/gnosis/compare/v0.3.0...v0.4.0
[v0.3.0]: https://github.com/n333k0/gnosis/compare/v0.2.2...v0.3.0
[v0.2.2]: https://github.com/n333k0/gnosis/compare/v0.2.1...v0.2.2
[v0.2.1]: https://github.com/n333k0/gnosis/compare/v0.2.0...v0.2.1
[v0.2.0]: https://github.com/n333k0/gnosis/compare/v0.1.0...v0.2.0
[v0.1.0]: https://github.com/n333k0/gnosis/releases/tag/v0.1.0
