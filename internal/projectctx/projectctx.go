...
// wired in at the chat surface (cmd/gnosis), keeping the core policy-free.
package projectctx
...
// fileName is the instruction file gnosis looks for. AGENTS.md is the emerging
...
// specific):
//
//   - ~/.gnosis/AGENTS.md                 user-global guidance
...
func Load(cwd string) ([]Doc, error) {
	...
	if home, err := os.UserHomeDir(); err == nil && home != "" {
		d, ok, err := readDoc(filepath.Join(home, ".gnosis", fileName))
		if err != nil {
