...
Gnosis tracks a small local baseline so contributors can notice meaningful growth
...
`cmd/gnosis/performance_test.go` and explain why in the pull request. Do not update
