...
import (
	...
	"github.com/n333k0/gnosis/internal/llm/retry"
)
...
// BuildRequest converts Gnosis's provider-neutral request to Chat Completions.
...
// ToLLMResponse converts Chat Completions output into Gnosis's neutral response.
