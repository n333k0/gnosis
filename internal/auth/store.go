...
import (
	...
	"github.com/n333k0/gnosis/internal/atomicfile"
)

// Store persists subscription credentials to a JSON file (default ~/.gnosis/auth.json),
...
// DefaultStore returns the Store at ~/.gnosis/auth.json.
func DefaultStore() (*Store, error) {
	home, err := os.UserHomeDir()
	if err != nil {
		return nil, fmt.Errorf("locate home directory: %w", err)
	}
	return NewStore(filepath.Join(home, ".gnosis", "auth.json")), nil
}
